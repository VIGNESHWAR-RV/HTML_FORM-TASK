  ...
  <div class="col-md-4" id="div1">
      ...
      <label for="Fname" class="col-3 col-sm-3">First Name<sup style="color:red">*</sup></label>
       ...
       <ul class="col-8 col-md-10 col-sm-7" style="list-style:none;margin-left: 15%%;">
          <li><input class="check" id="cb1" onclick="check()" type="checkbox" value="pazhaya-Soru"/><label for="cd1">-Pazhaya-Soru</label></li><br>
          <li><input class="check" id="cb2" onclick="check()" type="checkbox" value="Mutton-briyani"/><label for="cd2">-Mutton-Briyani</label></li><br>
          <li><input class="check" id="cb3" onclick="check()" type="checkbox" value="Chappathi"/><label for="cd3">-Chappathi</label></li><br>
          <li><input class="check" id="cb4" onclick="check()" type="checkbox" value="Mango-thokku"/><label for="cd4">-Mango-thokku</label></li><br>
          <li><input class="check" id="cb5" onclick="check()" type="checkbox" value="Meen-kulambu"/><label for="cd5">-Meen-Kulambu</label></li><br>
       </ul>
